...
public class ExtraLargeActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_extra_large);
        setupbackButton();
    ...
    public static Intent makeExtraLargeIntent(Context extraLargeContext) {
        return new Intent(extraLargeContext, ExtraLargeActivity.class);
    }
}

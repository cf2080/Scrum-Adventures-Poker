...
public class ExtraSmallActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_extra_small);
        setupbackButton();
    ...
    public static Intent makeExtraSmallIntent(Context extraSmallContext) {
        return new Intent(extraSmallContext, ExtraSmallActivity.class);
    }
}
